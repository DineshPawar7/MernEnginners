...
import blogs from '../data/newsBlogs.json'; // adjust path as needed
          ...
          {blogs.map((blog, index) => (
            ...
            >
              ...
              <div className="p-4 text-left">
                ...
                <h3 className="text-lg font-semibold text-white mb-2 font-roboto">{blog.title}</h3>
                <p className="text-sm text-gray-300 mb-4 font-work">{blog.excerpt}</p>
                <motion.a
                  href="#"
